...
提示词 §1.1.6 命中「素材 / 图标 / 组件库」后，读本文件拿仓库子项明细。阅读口径（全读 / 折减 / 读 ≠ 装 ≠ 用 / 读取回执）见提示词 §1.1.3，本文件不重述。
...
许可：Lobe UI / Lobe Icons 为 MIT（**商标另算**——品牌 logo 放进对外产品前先确认该品牌方的商标使用政策，拿不准按 §五 澄清）；Game Icon Pack 为 CC0-1.0（无需署名，商用可）。消费方式与商标边界见提示词 §14.11。
...
执行纪律、红线与失败路径见提示词 §14.11；本 skill 只装清单明细。
